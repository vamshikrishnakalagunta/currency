            ...
            public void onInit(int i) {
                if(i==TextToSpeech.SUCCESS){
                    ...
                    textToSpeech.setPitch(1/2);
                        ...
                        Toast.makeText(getApplicationContext(),"Click any where on screen to detect",Toast.LENGTH_SHORT).show();
                        textToSpeech.speak("Double click to start two way transactions", 1, null);
                        Toast.makeText(getApplicationContext(),"Double click to start two way transactions",Toast.LENGTH_SHORT).show();
                        textToSpeech.speak("long press to read out history", 1, null);
                        Toast.makeText(getApplicationContext(),"long press to read out history",Toast.LENGTH_SHORT).show();
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(i==1){
                    ...
                    textToSpeech.speak("Double clicked",1,null);
                    ...
                    Toast.makeText(getApplicationContext(),"triple clicked",Toast.LENGTH_SHORT).show();
                }
                i=0;
            }
        },300);
                ...
                public void onImageAvailable(ImageReader imageReader) {
                    ...
                    try{
                        ...
                        try {
                            ...
                            Toast.makeText(MainActivity.this, al.get(max), Toast.LENGTH_SHORT).show();
